...
#define bg_bn_gfxTilesLen 3520
extern const bn::tile bg_bn_gfxTiles[110];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item bg(
            regular_bg_tiles_item(span<const tile>(bg_bn_gfxTiles, 110), bpp_mode::BPP_4, compression_type::NONE), 
